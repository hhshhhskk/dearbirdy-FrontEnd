...
const ThrowAfterModal: React.FC<IProps> = ({ setShowThrowAfterModal }) => {
  ...
  return (
    <div className="fixed inset-0 z-999 bg-[rgba(51,51,51,0.80)] flex justify-center items-center">
      <div className="max-w-global mx-global flex flex-1 p-[20px_16px] flex-col items-start rounded-[18px] border border-[#F0F1EC] bg-white">
        ...
        <div
          className="cursor-pointer w-full text-center rounded-[10px] bg-[#292D32] p-[11px_16px] flex-col justify-center items-center mt-4"
          onClick={() => {
            router.push("/home");
